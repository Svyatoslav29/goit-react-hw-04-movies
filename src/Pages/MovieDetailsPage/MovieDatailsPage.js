...
import { Route, NavLink, useParams, useLocation, useHistory, useRouteMatch } from 'react-router-dom';
import { fetchGetMovieDetails } from '../../servicesApi/Api.js';
...
const Cast = lazy(() =>
  import("../../Components/Cast/Cast.js" /* webpackChunkName: "cast-view" */)
);
        ...
        {movie && (
          <>
            <div>
              ...
              <div className={s.moviePageAdInfo}>
